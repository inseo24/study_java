...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/7c7ac7a8-4e7e-4c91-9afe-4e1982dd098f/Untitled.png)
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/946215ec-b59a-4eae-8015-f7ad9bba7d22/Untitled.png)
...
- Method Information
    - Type에서 선언된 모든 Method의 정보가 저장되는 장소 Method를 선언한 순서대로 저장
...
- Class Variables
    - Class 변수 = static 변수
    - 모든 instance에 공유되면 instance가 없어도 접근이 가능
...
### Hotspopt JVM의 Heap Layout

- Generational Heap

![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/efde2bd5-d341-4201-8b67-2cf7f87799a5/Untitled.png)

![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/caf7befb-89fe-4c70-949e-362645c359f9/Untitled.png)

### IBM JVM의 Heap Layout

- One-Heap : IBM JVM의 Default Heap Layout

![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/2f9cebe4-dc30-4560-9cc6-0a858a5b86e1/Untitled.png)

- Kcluster : Pinned Class Object가 할당되는 곳
    ...
    - Pcluster가 꽉차면 2KB의 새로운 Pluster를 새로이 할당
    - Pcluster는 연속된 공간이 아니어도 되기 떄문에 Heap 여기저기에 할당이 가능
        
        → Fragmentation의 위험이 커짐
        

- Cache : Cache Allocation을 위한 부분
- Object 할당시 Thread간의 충돌을 회피하게 하기 위함
    - 스레드들이 힙에 공간을 할당 받을 때 Heap Lock을 사용
    - Heap Lock을 사용할 필요 없이 Thread마다 공간을 할당
    - 빠른 할당이 가능
...
- Size + Flag
    - 28 Btis : Object Size
    - 다음 2 Bits : Multipinned Bit, Garbage Collection 정보 - Compaction 시
